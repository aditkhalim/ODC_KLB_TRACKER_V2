...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        username = (EditText)findViewById(R.id.edtText_usernameRegister);
        password = (EditText)findViewById(R.id.edtText_passwordRegister);
        passwordConf = (EditText)findViewById(R.id.edtText_passwordConfRegister);
